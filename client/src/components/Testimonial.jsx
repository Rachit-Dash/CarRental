...
const Testimonial = () => {
    ...
    const testimonials = [
        { name: "Shreya Reddy", 
          ...
          testimonial: "I've have rented cars from various comapnies, but the service and attention to detail at CarRental is the best by far. Everything is handled professionally and efficiently from start to finish. Highly recommended!" 
        },
        { name: "Rithvika Mohanty", 
          location: "Bhubaneswar, Odisha",
          image: assets.testimonial_image_2,
          testimonial: "CarRental made my trips so much easier and effortles. The car was delivered right at my doorstep, and the customer service was top-notch!" 
        },
